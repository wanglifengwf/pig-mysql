 ...
 * 
 */
public class MysqlRecord implements Writable {
...
//	public MysqlRecord(Configuration conf)
...
//	}
	...
	/**
	 * Create a new MysqlRecord class out of a query result set
	 * @param results
	 *          ResultSet returned from running input split query
	 * @throws SQLException
	*/
	public MysqlRecord(ResultSet results) throws SQLException {
