...
import com.tsl.hadoop.MysqlInputFormat;
import com.tsl.hadoop.MysqlRecord;
import org.apache.pig.impl.util.UDFContext;

public class MysqlLoader extends LoadFunc implements LoadMetadata{
	...
	public MysqlLoader(String hostnames, String db, String port, String username, String password) {
	...
	private Tuple translate(MysqlRecord v) throws IOException {
		...
		for (int i = 0; i < columns; i++) {
			...
			switch (type) {
				...
				case Types.TINYINT:
				case Types.SMALLINT:
					result.set(i, Long.parseLong(String.valueOf(obj)));
					break;
				case Types.DECIMAL:
				case Types.NUMERIC:
				case Types.REAL:
				...
				case Types.FLOAT:
				case Types.DOUBLE:
					result.set(i, Double.valueOf(String.valueOf(obj)));
					break;
				case Types.BINARY:
				...
				case Types.BIT:
				case Types.BOOLEAN:
					result.set(i, Boolean.valueOf(String.valueOf(obj)));
					break;
				case Types.CHAR:
				...
				case Types.NVARCHAR:
				case Types.VARCHAR:
					result.set(i, String.valueOf(obj));
					break;
				case Types.DATE:
    ...
    public Tuple getNext() throws IOException {
        ...
        try {
            ...
            value = (MysqlRecord) reader.getCurrentValue();
    	...
    	try {
			...
			for(int i = 1; i <= rsmd.getColumnCount(); i++) {
				...
				switch(rsmd.getColumnType(i)) {
					...
					case Types.INTEGER:
					case Types.TINYINT:
					case Types.SMALLINT: type = DataType.LONG; break;
					case Types.REAL:
					case Types.DECIMAL:
					case Types.NUMERIC:
					...
					case Types.DATE:
					case Types.TIME:
					case Types.TIMESTAMP: type = DataType.CHARARRAY; break;
        		}
	...
	public String relativeToAbsolutePath(String location, Path curdir) throws IOException {
		try {
			String enc = URLEncoder.encode(location, "UTF-8");
			return enc;
